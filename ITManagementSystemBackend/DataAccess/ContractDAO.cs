...
namespace DataAccess
{
    public class ContractDAO
    {
        ...
        public static Contract? GetActiveContractByEmpId(int empId)
        {
            var context = new MyDbContext();
            return context.Contracts.Where(x => x.EmployeeId == empId && x.Status == EnumList.ContractStatus.Active).FirstOrDefault();
        }
