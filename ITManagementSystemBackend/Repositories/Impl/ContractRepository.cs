...
namespace Repositories.Impl
{
    public class ContractRepository : IContractRepository
    {
        ...
        public string CreateContract(ContractReq req)
        {
            ...
            var checkLeave = LevelDAO.FindLevelById(req.LevelId);
            if (checkEmployee == null)
        ...
        public Contract? GetActiveContractByEmployeeIdEqual(int employeeId)
        {
            return ContractDAO.GetActiveContractByEmpId(employeeId);
        }
    }
}
